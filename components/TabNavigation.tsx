        ...
        <View style={{ borderTopColor: "#8f8f8f44", borderTopWidth: 0.5, position: "absolute", zIndex: 100, bottom: 0, height: 85, width: "100%", flexDirection: "row", justifyContent: "space-around", alignContent: "center", alignItems: "center", backgroundColor: '#ffff', }}>
            <Pressable onPress={() => { router.push("/(session)/home") }} style={{ width: "30%" }}>
                <View style={styles.tabItemV}>
                    ...
                    <Text style={{ color: `${pathname == "/home" ? "#6969D7" : "#8f8f8f"}`, fontSize: 15, marginTop: 4 }} >Chats</Text>
                </View>
            </Pressable>
            <Pressable onPress={() => { router.push("/(session)/addFriend") }} style={{ width: "30%" }}>
                <View style={styles.tabItemV}>
                    <MaterialIcons name="add-circle-outline" color={pathname == "/addFriend" ? "#6969D7" : "#8f8f8f"} size={36} />
                    <Text style={{ color: `${pathname == "/addFriend" ? "#6969D7" : "#8f8f8f"}`, fontSize: 15, marginTop: 1 }} >Add</Text>
                </View>
            </Pressable>
            <Pressable onPress={() => { router.push("/(session)/myFriends") }} style={{ width: "30%" }}>
                <View style={styles.tabItemV}>
                    ...
                    <FontAwesome5 name="user-friends" color={pathname == "/myFriends" ? "#6969D7" : "#8f8f8f"} size={28} />
                    <Text style={{ color: `${pathname == "/myFriends" ? "#6969D7" : "#8f8f8f"}`, fontSize: 15, marginTop: 4 }} >Friends</Text>
                </View>
            </Pressable>
